...
<head>
    ...
    <title>MarketPlace Addis</title>
</head>

<body class="mb-48">
    <nav class="flex justify-between items-center mb-4">
        <a href="/"><img class="w-24" src="images/favicon.jpg" alt="" class="logo" /></a>
    ...
    <footer
        ...
        <a href="create.html" class="absolute top-1/3 right-10 bg-black text-white py-2 px-5">Post Item</a>
    </footer>
</body>
